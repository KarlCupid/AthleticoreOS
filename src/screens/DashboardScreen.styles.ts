...
export const styles = StyleSheet.create({
  ...
  signalCard: {
    ...
    backgroundColor: 'rgba(10, 14, 16, 0.80)',
    overflow: 'hidden',
  },
  readinessSignalCard: {
  ...
  readinessMetaList: {
    ...
    borderTopColor: 'rgba(245, 245, 240, 0.11)',
    gap: 2,
  },
  signalSection: {
    minWidth: 0,
  ...
  quickActionBlock: {
    ...
    justifyContent: 'center',
    gap: 6,
    backgroundColor: 'rgba(126, 144, 132, 0.30)',
    borderWidth: 1,
  ...
  quickActionBlockDone: {
    borderColor: 'rgba(245, 211, 107, 0.52)',
    backgroundColor: 'rgba(126, 144, 132, 0.38)',
  },
  quickActionImage: {
    width: 56,
    height: 42,
