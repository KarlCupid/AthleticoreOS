...
export const styles = StyleSheet.create({
  ...
  advancedToggle: { marginTop: SPACING.lg, minHeight: 64, borderWidth: 1, borderColor: COLORS.borderLight, borderRadius: RADIUS.md, padding: SPACING.md, backgroundColor: COLORS.surface, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: SPACING.sm },
  advancedToggleTextWrap: { flex: 1, minWidth: 0, paddingRight: SPACING.sm },
  ...
  advancedToggleAction: { flexShrink: 0, fontSize: 13, fontFamily: FONT_FAMILY.semiBold, color: COLORS.accent },
