...
- Competition-week body-mass floor when `daysToWeighIn <= 7`: `23 kcal/kg FFM`
- Final 72h floor when `daysToWeighIn <= 3`: `20 kcal/kg FFM`
- Basis: combat-sport body-mass protection. `20` is treated as a short competition-week minimum, not a normal operating target.
...
- Basis: lean-mass protection during aggressive body-mass change without inflating maintenance or surplus plans.

## Camp Intensity And Deload

- Peak phase with concurrent weight-class management: cap guided intensity at `RPE 7`
