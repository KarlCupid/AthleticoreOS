...
const GOAL_ROTATIONS: Record<PerformanceGoalType, Record<number, WorkoutFocus[]>> = {
  ...
  conditioning: {
    3: ['conditioning', 'full_body', 'sport_specific'],
    4: ['conditioning', 'lower', 'upper_pull', 'sport_specific'],
    5: ['conditioning', 'lower', 'upper_pull', 'full_body', 'sport_specific'],
    6: ['conditioning', 'lower', 'upper_pull', 'conditioning', 'full_body', 'sport_specific'],
  },
  boxing_skill: {
    3: ['full_body', 'upper_pull', 'conditioning'],
    4: ['full_body', 'upper_pull', 'lower', 'conditioning'],
    5: ['full_body', 'upper_pull', 'conditioning', 'lower', 'sport_specific'],
    6: ['full_body', 'upper_pull', 'conditioning', 'lower', 'full_body', 'sport_specific'],
  },
  weight_class_prep: {
    3: ['full_body', 'conditioning', 'recovery'],
    4: ['full_body', 'conditioning', 'upper_pull', 'recovery'],
    5: ['full_body', 'conditioning', 'upper_pull', 'lower', 'recovery'],
    6: ['full_body', 'conditioning', 'upper_pull', 'recovery', 'lower', 'sport_specific'],
  },
};
