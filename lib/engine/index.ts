...
export { calculateNutritionTargetEstimate, computeMacroAdherence, resolveDailyNutritionTargetEstimate, resolveNutritionMacros } from './calculateNutrition.ts';
...
export { DAILY_ENGINE_VERSION, buildDailyAthleteSummary, buildMicrocyclePlan, deriveProtectWindowFromRecentMissions } from './calculateMission.ts';
