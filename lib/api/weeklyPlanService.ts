...
export async function regenerateDayWorkout(
    ...
    const snapshot: BoxingGeneratedPlanEntrySnapshot = existingSnapshot ?? (() => {
        const migrated: BoxingGeneratedPlanEntrySnapshot = {
            ...
            athleticDevelopmentDomain: result.workout.athleticDevelopmentDomain,
            supportDomainLabel: result.workout.supportDomainLabel,
            sAndCRationale: result.workout.sAndCRationale,
            athleticDevelopmentRationale: result.workout.athleticDevelopmentRationale,
            boxingRelevance: result.workout.boxingRelevance,
            isBoxingPracticeReplacement: false,
            isCoachLedRequired: false,
            expectedFuelPriority: result.workout.expectedFuelPriority,
            expectedCarbDemandClass: result.workout.expectedCarbDemandClass,
            expectedRecoveryDemandClass: result.workout.expectedRecoveryDemandClass,
            expectedHydrationDemandClass: result.workout.expectedHydrationDemandClass,
            sessionEnergyDemandScore: result.workout.sessionEnergyDemandScore,
            sessionRecoveryDemandScore: result.workout.sessionRecoveryDemandScore,
