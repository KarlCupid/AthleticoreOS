...
exports.generateWarmupSets = generateWarmupSets;
// ─── Constants ───────────────────────────────────────────────
...
function nearestKBWeight(target) {
 ...
 */
function generateWarmupSets(input) {
...
// ─── Warmup Builders ─────────────────────────────────────────
function buildBarbellWarmup(workingWeight) {
    const sets = [];
    let setNum = 1;
...
function buildDumbbellWarmup(workingWeight) {
    const sets = [];
    let setNum = 1;
    // Very light weight
    if (workingWeight <= 15) {
...
function buildKettlebellWarmup(workingWeight) {
    const sets = [];
    let setNum = 1;
    // Light KB warmup
...
function buildMachineWarmup(workingWeight) {
    const sets = [];
    let setNum = 1;
    // Light x 10
...
function buildAbbreviatedWarmup(workingWeight, equipment) {
    const sets = [];
    let setNum = 1;
    // 50% x 5
    let fiftyWeight;
