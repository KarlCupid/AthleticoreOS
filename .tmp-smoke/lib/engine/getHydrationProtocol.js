...
exports.getHydrationProtocol = getHydrationProtocol;
exports.getCutHydrationProtocol = getCutHydrationProtocol;
/**
 * @ANTI-WIRING:
 ...
 */
function getHydrationProtocol(input) {
    ...
    const shedCapLbs = Math.round((input.currentWeightLbs * shedCapPercent) / 100 * 10) / 10;
 ...
 */
function getCutHydrationProtocol(input) {
